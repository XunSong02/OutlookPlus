...
export const mockEmails: Email[] = [
  {
    ...
    aiAnalysis: {
      ...
      suggestedActions: [
        {
          kind: 'reply_draft',
          text: 'Thanks for sharing the Q2 roadmap. I’ll review it and follow up by EOD tomorrow.',
          draft: {
            to: 'sarah.chen@techcorp.com',
            subject: 'Re: Q2 Product Roadmap Review - Urgent',
            body: 'Hi Sarah,\n\nThanks for sharing the Q2 roadmap. I’ll review it and follow up by EOD tomorrow.\n\nBest,',
          },
        },
        { kind: 'suggestion', text: 'Ignore for now if no action is required.' },
        { kind: 'suggestion', text: 'Check timeline feasibility with engineering.' },
      ],
    },
  },
  {
    ...
    aiAnalysis: {
      ...
      suggestedActions: [
        {
          kind: 'reply_draft',
          text: 'Thanks—these updates look solid. I’ll review the Figma and send detailed feedback shortly.',
          draft: {
            to: 'alex.rivera@designstudio.io',
            subject: 'Re: New Design Mockups for Dashboard',
            body: 'Hi Alex,\n\nThanks—these updates look solid. I’ll review the Figma and send detailed feedback shortly.\n\nCheers,',
          },
        },
        { kind: 'suggestion', text: 'Ignore if you already reviewed the link.' },
        { kind: 'suggestion', text: 'Check accessibility notes before replying.' },
      ],
    },
  },
  {
    ...
    aiAnalysis: {
      ...
      suggestedActions: [
        {
          kind: 'reply_draft',
          text: 'Thanks for the confirmation. Please share a detailed invoice PDF for our records.',
          draft: {
            to: 'notifications@stripe.com',
            subject: 'Re: Invoice #3492-01 payment successful',
            body: 'Hello,\n\nThanks for the confirmation. Could you share a detailed invoice PDF for our records?\n\nThanks,',
          },
        },
        { kind: 'suggestion', text: 'Ignore if you do not need an invoice.' },
        { kind: 'suggestion', text: 'Archive after saving the receipt.' },
      ],
    },
  },
  {
    ...
    aiAnalysis: {
      ...
      suggestedActions: [
        {
          kind: 'reply_draft',
          text: 'Yes—I\'d love to come! What time should I arrive on Saturday?',
          draft: {
            to: 'p.davis55@gmail.com',
            subject: 'Re: Weekend Plans?',
            body: 'Hi Mom,\n\nYes—I\'d love to come! What time should I arrive on Saturday?\n\nLove,',
          },
        },
        { kind: 'suggestion', text: 'Ignore if you already replied.' },
        { kind: 'suggestion', text: 'Check your calendar before committing.' },
      ],
    },
  },
  {
    ...
    aiAnalysis: {
      ...
      suggestedActions: [
        {
          kind: 'reply_draft',
          text: 'Please remove me from future job alert emails. Thanks.',
          draft: {
            to: 'jobs-listings@linkedin.com',
            subject: 'Re: 30+ new jobs match your preferences',
            body: 'Hello,\n\nPlease remove me from future job alert emails.\n\nThanks,',
          },
        },
        { kind: 'suggestion', text: 'Ignore if you want to keep receiving alerts.' },
        { kind: 'suggestion', text: 'Review roles later and archive if irrelevant.' },
      ],
    },
  },
  {
    ...
    aiAnalysis: {
      ...
      suggestedActions: [
        {
          kind: 'reply_draft',
          text: 'We are investigating the budget exceed alert and will follow up with root cause and mitigation.',
          draft: {
            to: 'no-reply-aws@amazon.com',
            subject: 'Re: AWS Budget Alert: Monthly Budget Exceeded',
            body: 'Hello,\n\nWe are investigating the budget exceed alert and will follow up with root cause and mitigation.\n\nThanks,',
          },
        },
        { kind: 'suggestion', text: 'Ignore if this is expected usage.' },
        { kind: 'suggestion', text: 'Check recent EC2/RDS changes and alerts.' },
      ],
    },
  },
    {
    ...
    aiAnalysis: {
      ...
      suggestedActions: [
        { kind: 'suggestion', text: 'Schedule the call for next Tuesday.' },
        { kind: 'suggestion', text: 'Prepare revenue share details beforehand.' },
        { kind: 'suggestion', text: 'Ignore if already confirmed a time.' },
      ],
    },
  },
  {
    ...
    aiAnalysis: {
      ...
      suggestedActions: [
        { kind: 'suggestion', text: 'Finish the draft and add agenda items.' },
        { kind: 'suggestion', text: 'Ignore for now if waiting on inputs.' },
        { kind: 'suggestion', text: 'Discard the draft if no longer needed.' },
      ],
    },
  },
];
